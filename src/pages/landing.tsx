    ...
    <main className="bg flex min-h-screen flex-col items-center justify-center w-full p-24 gap-10">
          ...
          <div className="flex flex-row items-center justify-evenly w-full space-y-4 z-20">
            ...
            <div className="flex flex-row justify-start mt-12 items-center">
              <button className="grid place-items-center px-8 rounded-3xl py-3 mx-3 bg-[#4884ee] text-white secondaryFont opacity-75 transition-all hover:opacity-100">Login</button>
              <button className="grid place-items-center px-8 rounded-3xl py-3 mx-3 bg-white text-[#4884ee] secondaryFont opacity-75 transition-all hover:opacity-100">SignUp</button>
            </div>
            </div>
        </div>
    </main>
