        ...
        <>
            <main className="flex min-h-screen flex-col items-center justify-center bg-[#15132f] w-full p-6 md:p-12 lg:p-20 relative">
                <div className="flex flex-row justify-center items-center w-full z-20">
                    <p className="blueGradText primaryFont text-3xl md:text-5xl lg:text-7xl md:leading-[4rem]">Latest News</p>
                    <img className="w-12 md:w-32" src="https://cdn3d.iconscout.com/3d/premium/thumb/cute-robot-reading-book-5665783-4721944.png?f=webp" alt="" />
                </div>
